...
def my_config():
    ...
    train_exp_dir = '/data/xieyiping/projectone/Physnet/Wloss/result_PURE_WD3/%d' % train_exp_num  # training experiment directory
...
def my_main(_run, epo, train_exp_dir, device, time_interval):
    ...
    # test_list = ['/data/xieyiping/dataset/PURE_numpy/PURE_filter_crop_numpy_box/10-01.npz',
    #              '/data/xieyiping/dataset/PURE_numpy/PURE_filter_crop_numpy_box/10-02.npz',
    #              '/data/xieyiping/dataset/PURE_numpy/PURE_filter_crop_numpy_box/10-03.npz',
    #              '/data/xieyiping/dataset/PURE_numpy/PURE_filter_crop_numpy_box/10-04.npz',
    #              '/data/xieyiping/dataset/PURE_numpy/PURE_filter_crop_numpy_box/10-05.npz',
    #              '/data/xieyiping/dataset/PURE_numpy/PURE_filter_crop_numpy_box/10-06.npz']
    ...
    for i in range(0,30):
        ...
        # model.load_state_dict(torch.load('/data/xieyiping/projectone/Physnet/Wloss/result_PURE_WD3/1/epoch%d.pt' % (i), map_location=device))  # load weights to the model
        model.load_state_dict(torch.load('/data/xieyiping/projectone/Physnet/Wloss/result_COHFACE_WD_test2/1/epoch%d.pt' % (i), map_location=device))  # load weights to the model
        #
        bvp_all = []
        rppg_all = []
