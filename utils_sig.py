...
def sig_out_hr(sig_list, lowcut, highcut, fs, order=2):
    bvp_filter = butter_bandpass(sig_list, lowcut, highcut, fs, order)
    hr, sig_f_original, x_hr = hr_fft(bvp_filter, fs)
    return hr
